const { Card } = window.AdyenWeb;const clientKey = document.getElementById("clientKey").innerHTML;
...
createCheckout(async (adyenCheckout) => {
    new Card(adyenCheckout, getCardConfiguration()).mount('#payment-container');
});
