...
namespace adyen_dotnet_checkout_example_advanced.Controllers
{
    ...
    public class ApiController : ControllerBase
    {
        ...
        private const string MerchantApplicationName = "adyen-dotnet-online-payments";
        private const string MerchantApplicationVersion = "checkout-example-advanced";
        private const string AdyenWebName = "adyen-web";
        private const string AdyenWebVersion = "6.30.0";
